...
public enum ModArmorMaterials implements StringIdentifiable, ArmorMaterial {
    ABYSSAL_HUNTERS("abyssal_hunters", 40, Util.make(new EnumMap(ArmorItem.Type.class), map -> {
        map.put(ArmorItem.Type.BOOTS, 3);
        map.put(ArmorItem.Type.LEGGINGS, 6);
        map.put(ArmorItem.Type.CHESTPLATE, 8);
        map.put(ArmorItem.Type.HELMET, 3);
    }), 30, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 5.0F, 0.2F, () -> Ingredient.ofItems(Items.PRISMARINE_SHARD)),

    SHADOW_GUARD("shadow_guard", 39, Util.make(new EnumMap(ArmorItem.Type.class), map->{
        map.put(ArmorItem.Type.BOOTS, 2);
        map.put(ArmorItem.Type.LEGGINGS, 5);
        map.put(ArmorItem.Type.CHESTPLATE, 7);
        map.put(ArmorItem.Type.HELMET, 2);
    }), 25, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 4.0F, 0.1F, () -> Ingredient.ofItems(Items.BAMBOO))
    ...
    public String getName() {
        return ArknightMod.MOD_ID + ":" + this.name;
    }
